...
//body
fill(50);
rect(1000, 350, 300, 300, 10);
rect(900, 350, 100, 230, 10);
rect(1300, 350, 100, 230, 10);
rect(1030, 650, 100, 350, 10);
rect(1170, 650, 100, 350, 10);
//head
fill(60);
rect(1025, 100, 250, 250, 10);
//ears
fill(75);
rect(1005, 150, 20, 80, 10);
rect(1275, 150, 20, 80, 10);
//eyes
fill(100);
strokeWeight(3);
ellipse(1100, 175, 50, 50);
ellipse(1200, 175, 50, 50);
strokeWeight(10);
point(1100, 175);
point(1200, 175);
//noses
strokeWeight(3);
fill(120);
triangle(1150, 190, 1120, 250, 1185, 250 )
//mouth
noFill();
strokeWeight(3);
beginShape();
