...
let counterOne = 10;
while(counterOne > 0) {                                  
    console.log(counterOne, "You're crazy :)");
    counterOne--;
}
...
/*
    >_ You're not gonna use while loop everytime, you'll use for loops most times.
    >_ You can't re-assign a variable in Javascript as python (const).
    >_ 
*/